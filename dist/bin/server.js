...
const arrMiddlewares = [bodyParser.json(), bodyParser.urlencoded({ extended: true }), logger_1.default];
/**
 * Import routes
 */
...
const arrRoutes = [home_router_1.default, login_router_1.default, register_router_1.default, olymp_router_1.default];
/**
 * Init Web-site
 */
